  ...
  en: {
    ...
    cases: [
      ...
      },
      {
        ...
        intelligence: "The everyday layer handles the conversation; the deeper layer joins when analysis or automation needs more context.",
  ...
  ro: {
    ...
    cases: [
      ...
      },
      {
        ...
        intelligence: "Nivelul de zi cu zi gestionează conversația; nivelul profund intră când analiza sau automatizarea au nevoie de mai mult context.",
